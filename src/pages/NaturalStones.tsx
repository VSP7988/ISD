...
import { galleryImages, productImages } from '../config/images';
    ...
    <div className="min-h-screen bg-black">
      ...
      <div className="relative h-[70vh] w-full overflow-hidden">
        <div
          ...
          style={{
            backgroundImage: `url(${productImages.naturalStones})`,
          }}
        >
        ...
        <div className="relative h-full flex items-center justify-center">
          <div className="text-center">
            <h1 className="text-5xl md:text-7xl font-bold text-white mb-4 animate-fadeIn">
              Natural <span className="text-orange-500">Stones</span>
            </h1>
            <button
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-8">
            Nature's Finest <span className="text-orange-500">Creations</span>
          </h2>
          <p className="text-gray-400 text-lg leading-relaxed">
            Our natural stone collection represents Earth's finest offerings, carefully selected and expertly finished to bring timeless beauty to your spaces. Each piece tells a unique story of geological artistry, formed over millions of years beneath the Earth's surface. From the dramatic veining of marble to the subtle patterns of granite, our collection showcases nature's inherent ability to create incomparable designs. These stones not only provide durability and functionality but also bring a piece of natural history into your environment.
          </p>
        </div>
      </section>
      ...
      <section className="py-20 bg-gray-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {galleryImages.naturalStones.map((image, i) => (
              <div
                key={i}
      ...
      {/* Lightbox */}
      <Lightbox
        slides={galleryImages.naturalStones}
        open={index >= 0}
        index={index}
        close={() => setIndex(-1)}
        styles={{
